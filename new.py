...
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing",
                   ...
                   menu_items={'About': """# This app is created by *Deepa Muralidharan!*"""})


st.title("Welcome :green[Technophiles] Here :green[Deepa Muralidharan]")

option = st.selectbox(
    '',
    ('Project Endeavor', 'YouTube API Data Into Mongo Document', 'Mongo Document Into SQL Records',
     'SQL Data Anlaysis','Expertise Highlighted'))

if option == 'Project Endeavor':
    ...
    st.info("""      Python (Scripting)\n\nData Collection\n\nMongoDB\n\nSQL\n\nAPI Integration\n\nData Managment using MongoDB (Atlas) and MySQl\n\nIDE: Pycharm Community Version\n\n """)
    st.subheader("For More Queries Connect :green[Deepa Muralidharan] Through [Linkedln](https://www.linkedin.com/in/deepa-muralidharan-87793887/)")
    st.subheader("Make sure to give ⭐ In [GitHub](https://github.com/MuralidharanDeepa/YouTube-Data-Harvesting-Warehousing) ")    

# ========================================   /     Data collection zone and Stored data to MongoDB    /   =================================== #

# Data collection zone
elif option == 'YouTube API Data Into Mongo Document':
    st.header(':black[Data collection zone]')
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyBjdIRMWPlfGy4Sbcc6hLUzPQpxXwUGzuI' # provide api key here
        ...
        mydb = client['DataSync']

        # create a collection
        collection = mydb['Youtube']
...
# ====================================================   /     Channel Analysis zone     /   ================================================= #
    ...
    st.header(':black[Channel Data Analysis zone]')
    ...
    # -----------------------------------------------------     /   Questions   /    ------------------------------------------------------------- #
    st.subheader(':black[Channels Analysis ]')
    ...
    # Q2
        ...
        with col2:
            ...
            fig_vc.update_traces(textfont_size=16,marker_color='#FF0000')
    ...
    # Q3
        ...
        with col2:
            ...
            fig_topvc.update_traces(textfont_size=16,marker_color='#FF0000')
    ...
    # Q7
        ...
        with col2:
            ...
            fig_topview.update_traces(textfont_size=16,marker_color='#FF0000')
    ...
    # Q8
        ...
        cursor.execute("SELECT channel.Channel_Name, video.Video_Name, video.Published_date FROM channel JOIN playlist ON channel.Channel_Id = playlist.Channel_Id JOIN video ON playlist.Playlist_Id = video.Playlist_Id  WHERE EXTRACT(YEAR FROM Published_date) = 2023;")
