...
mycon = pm.MongoClient('mongodb://127.0.0.1:27017')
db = mycon["DataSync"]
collection = db['YouTube']

# Sql Python Connectivity
mycon1 = sql.connect(host="localhost",user="root",password="12345",database="youtubedata")

cursor=mycon1.cursor()

# API Key :

api_key = 'AIzaSyD8KZdtqZ6smB_N2cxDBvQc7K2F54SZcplg' # provide api key here
...
class YT2SQL:
    ...
    # Step 1:   Getting YT Channel Details
    ...
    # Step 2: Getting YT Channel All Video IDs
    ...
    # Step : 3  Getting All Videos , Comments Details
...
#----------------------------------------------------------------------------------------------------------------
    ...
    # Step 4 : Getting All PlaylistIds , Videos Ids
...
#---------------------------------------------------------------------------------------------------------------------
    ...
    # Step 5: Merging All Deatils Of Given Channel Together
...
#_________________________________________________________________________________________________________________-
    # Step 6 : Api Data Into Mongo Documents
...
#------------------------------------------------------------------------------------------------------------------
    ...
    # Step 7 : Channel Names getting From MongoDB Documents
...
#-------------------------------------------------------------------------------------------------------------
    ...
    # Step 8 : Getting one Mongo Document then convert into DF
...
#--------------------------------------------------------------------------------------------------------
    ...
    # Step 9 : To Transform All Data For Data Load Process
...
#------------------------------------------------------------------------------------------------------------------
    # Step 10 : Data Load Proces From 4 df to 4 table records
...
#------------------------------------------------------------------------------------------------------------------------------
    ...
    # Step 11 :Fetchichg  Solution  For SQL  Data Analsyis queries
    def da_query(self):
    ...
    if st.button('PROCESS'):
        if len(chan_id) == 24:
            ...
            if len(di) <= 0:
                    ...
                    Video_Details = Object.get_vd_&_cd(youtube, videos_id,
